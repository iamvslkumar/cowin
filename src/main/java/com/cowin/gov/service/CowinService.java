...
public class CowinService {
	...
	public DistrictResponse getAll() {
		...
		try {
            ...
            ResponseEntity<DistrictResponse>  response = restTemplate.exchange("https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByDistrict?district_id="+district.getDistrictId()+"&date=11s-05-2021", HttpMethod.GET,entity,DistrictResponse.class);
